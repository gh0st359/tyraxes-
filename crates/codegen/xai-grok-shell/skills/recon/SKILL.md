...
Use this skill for scoped recon. Prefer installed tools; save evidence under `.grok/redteam/`.

## Goals

1. Confirm scope, exclusions, and success criteria in `.grok/redteam/scope.md`.
...
4. **Normalize** — write `.grok/redteam/notes/recon-inventory.md` as a table.
...
mkdir -p .grok/redteam/artifacts/recon .grok/redteam/notes
